...
export default async function deleteCategory(parent, args, context) {
  let newdeleteCategory = await context.mutations.deleteCategory(context, args);
